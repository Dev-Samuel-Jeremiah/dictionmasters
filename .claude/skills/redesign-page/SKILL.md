---
name: redesign-page
description: Redesign Diction Masters templates to match the dashboard/EchoSpell design system (hero, 3D cards, rings), then verify in a browser. Pass the templates to redesign.
argument-hint: <templates to redesign, e.g. templates/quick_words/*.html>
---
